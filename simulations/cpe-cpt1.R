...
beta.name<-paste("beta-cpe-cpt1-",ER,"-",PNR,"-",SEED,".csv",sep="")
lambda.name<-paste("lam-cpe-cpt1-",ER,"-",PNR,"-",SEED,".csv",sep="")
eta.name<-paste("eta-cpe-cpt1-",ER,"-",PNR,"-",SEED,".csv",sep="")
rho.name<-paste("rho-cpe-cpt1-",ER,"-",PNR,"-",SEED,".csv",sep="")
HD.name<-paste("HD-cpe-cpt1-",ER,"-",PNR,"-",SEED,".csv",sep="")
